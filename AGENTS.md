...
- **Copy reference:** the live site at [canlis.com](https://canlis.com)
...
| `redesign/menu/index.html` | Menu |
| `redesign/story/index.html` | Our story |
| `redesign/wine/index.html` | Wine |
| `redesign/lounge/index.html` | The Lounge |
| `redesign/careers/index.html` | Careers |
| `redesign/reservations/index.html` | Reservations |
| `redesign/giftcards/index.html` | Gift cards |
| `redesign/private-events/index.html` | Private Events |
| `redesign/style.css` | Main design system and inner-page layouts |
